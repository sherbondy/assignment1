...
namespace {
    ...
    {    
        ...
        /* By default, most systems have their standard error output set to the console, 
           where text messages are shown, although this can generally be redirected. */
        cerr << "  " << n << " cps" << endl;
        ...
        // vary parsing based on dim, but still make 3f vector.
