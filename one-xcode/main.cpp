...
namespace
{
    ...
    // This is the camera
    // why is camera capitalized? Because it's a singleton?
    // inconsistent naming: c++ types are not capitalized...
    // The canonical rule:
    // Do capitalize the first letter of class names
    Camera camera;
